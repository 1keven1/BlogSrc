...
let sDoge = new Shader('./DefaultShader/DefaultVert.vert', './Res/ShowCase/StartDoge/Doge.frag');
let sFloor = new Shader('./DefaultShader/DefaultVert.vert', './DefaultShader/S_BCNRAO.frag');
...
let mDoge = new Material(sDoge, shadowCaster1);
let mFloor = new Material(sFloor, shadowCaster2);
...
// 想编辑的Shader列表
this.codeEditor.editableShaderList = [sFloor, sDoge];
