...
function main()
{
    ...
    loadShaderFile(gl, '2_TransformTriangle.vert', gl.VERTEX_SHADER);
    loadShaderFile(gl, '2_TransformTriangle.frag', gl.FRAGMENT_SHADER);
}
...
function start(gl)
{
    ...
    transformMatrix.translate(0.5, 0, 0);
